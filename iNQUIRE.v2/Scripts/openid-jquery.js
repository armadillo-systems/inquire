...
openid = {
	...
	useInputBox : function(provider) {
		...
		if (provider['name'] == 'OpenID') {
			id = this.input_id;
			value = 'http://';
			style = 'background: #FFF url(' + this.img_path + 'openid-inputicon.gif) no-repeat scroll 0 50%; padding-left:18px; margin-left:-18px;';
		}
		html += '<input id="' + id + '" type="text" style="' + style + '" name="' + id + '" value="' + value + '" /><br />'
				+ '<input id="openid_submit" type="submit" value="' + this.signin_text + '"/><br class=clear/>' ;
		input_area.empty();
